...
const Home = () => {
  const str = "henry ford please give me one car"
  const strarr = ['henry', 'ford', 'please', 'give','me','one','car']
  console.log(str.slice + " " + strarr.slice)
  return (
    <main>
    <Navbar />
    <section className="h-screen w-full  bg-neutral-950 rounded-md  !overflow-visible relative flex flex-col items-center  antialiased">
        <div className="absolute inset-0  h-full w-fullb items-center px-5 py-24 [background:radial-gradient(125%_125%_at_50%_10%,#000_35%,#223_100%)]"></div>
